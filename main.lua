function love.load()
  ...
  dangerZone = world:newRectangleCollider(-500, 800, love.graphics:getWidth(), 50, { collision_class = "Danger" })
...
function loadMap(mapName)
  ...
  for i, checkpoint in ipairs(gameMap.layers["Checkpoint"].objects) do
